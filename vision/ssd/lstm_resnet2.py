...
class ResNetLSTM2(nn.Module):
	def __init__(self, num_classes, is_test=False, config=None, num_lstm=5):
		...
		Conv2d(in_channels=16, out_channels=4 * 4, kernel_size=3, padding=1),
		Conv2d(in_channels=16, out_channels=4 * 4, kernel_size=3, padding=1), # TODO: change to kernel_size=1, padding=0?
		])
		...
		Conv2d(in_channels=16, out_channels=4 * num_classes, kernel_size=3, padding=1),
		Conv2d(in_channels=16, out_channels=4 * num_classes, kernel_size=3, padding=1), # TODO: change to kernel_size=1, padding=0?
		])
